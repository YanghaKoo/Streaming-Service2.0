    ...
    function constructstarRatingContent() {
      ...
      for(let i=0; i<5; i++){
        ...
        tag.addEventListener("mouseover",function(){          
          for(let j=0; j<=i; j++){          
            //_aside.children[j].children[0].setAttribute('src','http://harperlibrary.typepad.com/.a/6a0105368f4fef970b01b7c8ada197970b-800wi')            // 이미지 변경이 안됨            
            //_aside.children[j].children[0].setAttribute('src','https://cdn3.iconfinder.com/data/icons/stars-5/512/gold_star-512.png')            
